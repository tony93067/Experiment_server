...
#endif
{
    ...
    if(mode == 1)
    {
        strcat(result_addr, "Sender_UDT1_Monitor_");
    ...
    {
        strcat(result_addr, "Sender_CTCP1_Monitor_");
        strcat(result_addr, "MSS");
        strcat(result_addr, temp_MSS);
        strcat(result_addr, "_TCP");
        strcat(result_addr, temp_BK_TCP);
    ...
    {
        strcat(result_addr, "Sender_CBiCTCP1_Monitor_");
        strcat(result_addr, "MSS");
        strcat(result_addr, temp_MSS);
        strcat(result_addr, "_TCP");
        strcat(result_addr, temp_BK_TCP);
    ...
    {
        strcat(result_addr, "Receiver_CHTCP1_Monitor_");
        strcat(result_addr, "MSS");
        strcat(result_addr, temp_MSS);
        strcat(result_addr, "_TCP");
        strcat(result_addr, temp_BK_TCP);
